...
- :fire: **π0**: A Vision-Language-Action Flow Model for General Robot Control, *arXiv 2024*. [[Paper](https://arxiv.org/abs/2410.24164)] [[Website](https://www.physicalintelligence.company/blog/pi0)] [[Physical Intelligence](https://www.physicalintelligence.company/)] [[Unofficial Code](https://github.com/allenzren/open-pi-zero)]
...
- **RoboVLMs**: Towards Generalist Robot Policies: What Matters in Building Vision-Language-Action Models, *arXiv 2024.12*. [[Paper](https://arxiv.org/abs/2412.14058)] [[Website](https://robovlms.github.io/)] [[Code](https://github.com/Robot-VLAs/RoboVLMs)]
- [[Robo-VLM](https://github.com/Nicolinho/RoboVLM)], An open-source implementation tailored for utilizing VLMs in instruction-based robot control.
